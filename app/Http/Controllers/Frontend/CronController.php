...
class CronController extends Controller
{
    ...
    public function addxml()
    {
        ...
        foreach ($xml_arr['listing'] as $key => $value) {
            ...
            $property->status     = array_key_exists("general_listing_information", $value) ? (!empty($value['general_listing_information']['status']) ? $value['general_listing_information']['status'] : 'active') : 'active';
