...
@else
    @section('title',  'Rent a property | '.$name)
                    ...
                    <div class="row g-3 justify-content-center">
                        <div class="col-12 col-lg-6 col-md-6">
                            <div class="text-start">
                                <div class="mb-3">
                                    <h4 class="text-primary">Why Rent Property With Us?</h4>
                                </div>
                                <div>
                                ...
                                <form action="{{route('valuationForm')}}" method="post">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12 col-lg-12 col-md-12">
                                          ...
                                          <input type="hidden" name="formName" value="Rent Property Form">
                                        </div>
                                        <div class="col-12 col-lg-12 col-md-12">
