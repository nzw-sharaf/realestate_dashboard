                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row float-right">
                                ...
                                <div class="">
                                    <a href="{{ route('dashboard.blogs.create') }}" class="btn btn-block btn-primary">
                        ...
                        <div class="collapse @if(count(request()->all())> 0) show @endif" id="collapseFilter">
                            <form method="GET" action="{{ route('dashboard.blogs.index') }}">
                                ...
                                <tbody>
                                    @foreach ($blogs as $key => $blog)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge @if ($blog->status === 'active') bg-success @else bg-danger @endif">
                                                    {{ $blog->status }}
                                                </span>
                                            </td>
